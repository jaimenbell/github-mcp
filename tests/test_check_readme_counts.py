...
#   "tests-86 passing / 1 skipped-brightgreen" percent-encoded.
# ---------------------------------------------------------------------------
...
def test_parse_claimed_counts_matches_real_badge_phrasing():
    ...
    assert claim == check_readme_counts.Counts(total=87, passed=86, skipped=1)
...
<testsuites>
<testsuite name="pytest" errors="0" failures="0" skipped="1" tests="87" time="7.9">
</testsuite>
</testsuites>
"""
...
<testsuites>
<testsuite name="pytest" errors="0" failures="3" skipped="1" tests="87" time="7.9">
</testsuite>
</testsuites>
"""
...
def test_parse_actual_counts_from_junit(tmp_path):
    ...
    assert actual == check_readme_counts.Counts(total=87, passed=86, skipped=1)
...
def test_parse_actual_counts_subtracts_failures(tmp_path):
    ...
    actual = check_readme_counts.parse_actual_counts(junit_file)
    # 87 total - 1 skipped - 3 failures = 83 passed
    assert actual == check_readme_counts.Counts(total=87, passed=83, skipped=1)
...
def test_compare_match_passes():
    claimed = check_readme_counts.Counts(total=87, passed=86, skipped=1)
    actual = check_readme_counts.Counts(total=87, passed=86, skipped=1)
...
def test_compare_drift_fails():
    claimed = check_readme_counts.Counts(total=74, passed=73, skipped=1)
    actual = check_readme_counts.Counts(total=87, passed=86, skipped=1)
    ok, message = check_readme_counts.compare(claimed, actual)
    assert ok is False
    assert "74" in message and "87" in message


def test_compare_missing_claim_fails():
    ok, message = check_readme_counts.compare(None, check_readme_counts.Counts(total=87, passed=86, skipped=1))
    assert ok is False

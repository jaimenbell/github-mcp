...
| GitHub rate-limit (403 + `X-RateLimit-Reset`) surfaces as a typed error with reset time, never a crash | `github_mcp/client.py::_rate_limit_error` | `tests/test_client.py::TestRateLimitError`, `tests/test_read.py::TestUnauthDegrade::test_get_repo_rate_limited_without_token_is_typed` |
